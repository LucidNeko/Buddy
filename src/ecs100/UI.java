...
public class UI {
    ...
    //    private Box IOarea;
    public PixelImage canvas = new PixelImage(1600, 900);
    public Ecs100Canvas ecs100Canvas;   //    private DEBUG
...
//        theUI.canvas.redisplay();
    ...
    private UI() {
        ...
        ecs100Canvas = new Ecs100Canvas();
        ecs100Canvas.setFocusable(true);   // NEW JAN 2015
        textPane = new Ecs100TextArea(0,60);
        textPane.setFont(Font.decode("Monospaced"));


        JScrollPane textSP = new JScrollPane(textPane);
        JScrollPane graphicsSP = new JScrollPane(ecs100Canvas,
		...
		Keyboard.register(ecs100Canvas);
		Mouse.register(ecs100Canvas);
		frame.add(ecs100Canvas);
		
//		CanvasRenderer canvasRenderer = new CanvasRenderer(canvas);
//		Keyboard.register(canvasRenderer);
//		Mouse.register(canvasRenderer);
//		frame.add(canvasRenderer);
...
//        theUI.frame.repaint();
    ...
    public static void repaintAllGraphics() {
        ensureGraphics();
//        theUI.frame.repaint();
        theUI.ecs100Canvas.redisplayAll();
    }
...
//    	theUI.frame.repaint();
    ...
    public static void setColor(Color col){
        checkInitialised();
        theUI.ecs100Canvas.setColor(col);
    }
    ...
    public static void setFontSize(double size) {
        theUI.ecs100Canvas.setFontSize((int)size);
    }
    
    public static void setFont(Font font) {
    	theUI.ecs100Canvas.setFont(font);
    }
    ...
    public static void setLineWidth(double width){
        theUI.ecs100Canvas.setLineWidth(width);
    }
    ...
    public static Graphics2D getGraphics() {
        return (Graphics2D) theUI.ecs100Canvas.getBackingGraphics();
    }
    
    public static PixelImage getCanvas() {
    	return theUI.canvas;
    }
    ...
    public static int getCanvasHeight() {
        return theUI.ecs100Canvas.getHeight();
    }
    ...
    public static int getCanvasWidth() {
        return theUI.ecs100Canvas.getWidth();
    }
    ...
    public static void drawLine(double x1, double y1, double x2, double y2) {
        theUI.ecs100Canvas.draw(new Line2D.Double(x1, y1, x2, y2));
    }
    ...
    public static void eraseLine(double x1, double y1, double x2, double y2) {
        ensureGraphics();
        theUI.ecs100Canvas.erase(new Line2D.Double(x1, y1, x2, y2));
    }
    ...
    public static void invertLine(double x1, double y1, double x2, double y2) {
        ensureGraphics();
        theUI.ecs100Canvas.invert(new Line2D.Double(x1, y1, x2, y2));
    }
    ...
    public static void drawRect(double x, double y, double width, double height) {
        ensureGraphics();
        theUI.ecs100Canvas.draw(new Rectangle2D.Double(x, y, width,height));
    }
    ...
    public static void fillRect(double x, double y, double width, double height) {
        ensureGraphics();
        theUI.ecs100Canvas.fill(new Rectangle2D.Double(x, y, width,height));
}
    ...
    public static void eraseRect(double x, double y, double width, double height) {
        ensureGraphics();
        theUI.ecs100Canvas.erase(new Rectangle2D.Double(x, y, width,height));
    }
    ...
    public static void invertRect(double x, double y, double width, double height) {
        ensureGraphics();
        theUI.ecs100Canvas.invert(new Rectangle2D.Double(x, y, width,height));
    }
    ...
    public static void drawString(String s, double x, double y) {
        ensureGraphics();
        theUI.ecs100Canvas.drawString(s, (int)x, (int)y);
    }
    ...
    public static void eraseString(String s, double x, double y) {
        ensureGraphics();
        theUI.ecs100Canvas.eraseString(s, (int)x, (int)y);
    }
    /*---- Invert String---------------------------------------------------*/
    ...
    public static void invertString(String s, double x, double y) {
        ensureGraphics();
        theUI.ecs100Canvas.invertString(s, (int)x, (int)y);
    }
    ...
    public static void drawOval(double x, double y, double width, double height) {
        ensureGraphics();
        theUI.ecs100Canvas.draw(new Ellipse2D.Double(x, y, width, height));
    }
    ...
    public static void fillOval(double x, double y, double width, double height) {
        ensureGraphics();
        theUI.ecs100Canvas.fill(new Ellipse2D.Double(x, y, width,height));
    }
    ...
    public static void eraseOval(double x, double y, double width, double height) {
        ensureGraphics();
        theUI.ecs100Canvas.erase(new Ellipse2D.Double(x, y, width,height));
    }
    ...
    public static void invertOval(double x, double y, double width, double height) {
        ensureGraphics();
        theUI.ecs100Canvas.invert(new Ellipse2D.Double(x, y, width,height));
    }
    ...
    public static void drawArc(double x, double y, double width, double height, 
        ...
        ensureGraphics();
        theUI.ecs100Canvas.draw(new Arc2D.Double(x, y, width, height, startAngle, arcAngle, Arc2D.PIE));
    }
    ...
    public static void fillArc(double x, double y, double width, double height, 
                               double startAngle, double arcAngle) {
        ensureGraphics();
        theUI.ecs100Canvas.fill(new Arc2D.Double(x, y, width, height, startAngle, arcAngle, Arc2D.PIE));
    }
    ...
    public static void eraseArc(double x, double y, double width, double height, 
                                double startAngle, double arcAngle) {
        ensureGraphics();
        theUI.ecs100Canvas.erase(new Arc2D.Double(x, y, width, height, startAngle, arcAngle, Arc2D.PIE));
    }
    ...
    public static void invertArc(double x, double y, double width, double height, 
                                double startAngle, double arcAngle) {
        ensureGraphics();
        theUI.ecs100Canvas.invert(new Arc2D.Double(x, y, width, height, startAngle, arcAngle, Arc2D.PIE));
    }
    ...
    public static void drawImage(String fileName, double x, double y, double width, double height) {
        ensureGraphics();
        theUI.ecs100Canvas.drawImage(fileName, (int)x, (int)y, (int)width, (int)height);
    }
    ...
    public static void drawImage(String fileName, double x, double y) {
        ensureGraphics();
        theUI.ecs100Canvas.drawImage(fileName, (int)x, (int)y);
    }
    ...
    public static void drawImage(Image img, double x, double y, double width, double height) {
        ensureGraphics();
        theUI.ecs100Canvas.drawImage(img, (int)x, (int)y, (int)width, (int)height);
    }
    ...
    public static void drawImage(Image img, double x, double y) {
        ensureGraphics();
        theUI.ecs100Canvas.drawImage(img, (int)x, (int)y);
    }

    public static void drawImage(PixelImage img, double x, double y) {
    	ensureGraphics();
    	theUI.ecs100Canvas.drawImage(img.asBufferedImage(), (int)x, (int)y);
    }
    ...
    public static void eraseImage(String fileName, double x, double y) {
        ensureGraphics();
        theUI.ecs100Canvas.eraseImage(fileName, (int)x, (int)y);
    }
    ...
    public static void eraseImage(Image img, double x, double y) {
        ensureGraphics();
        theUI.ecs100Canvas.eraseImage(img, (int)x, (int)y);
    }
    ...
    public static void drawPolygon(double[] xPoints, double[] yPoints, int nPoints) {
        ensureGraphics();
        theUI.ecs100Canvas.draw(makePolygon(xPoints, yPoints, nPoints));
    }
    ...
    public static void fillPolygon(double[] xPoints, double[] yPoints, int nPoints) {
        ensureGraphics();
        theUI.ecs100Canvas.fill(makePolygon(xPoints, yPoints, nPoints));
    }
    ...
    public static void erasePolygon(double[] xPoints, double[] yPoints, int nPoints) {
        ensureGraphics();
        theUI.ecs100Canvas.erase(makePolygon(xPoints, yPoints, nPoints));
    }
    ...
    public static void invertPolygon(double[] xPoints, double[] yPoints, int nPoints) {
        ensureGraphics();
        theUI.ecs100Canvas.invert(makePolygon(xPoints, yPoints, nPoints));
    }
...
/*==== OUTPUT to TEXT PANE=============================================*/
    ...
    */
    ...
    public static void setKeyListener(UIKeyListener obj) {
        checkInitialised();
        if (theUI.kl != null){
            theUI.ecs100Canvas.removeKeyListener(theUI.kl);
        }
        theUI.kl = new Ecs100KeyListener(obj);
	theUI.ecs100Canvas.addKeyListener(theUI.kl);
    }
    ...
    public static void setMouseListener(UIMouseListener obj) {
        checkInitialised();
        if (theUI.ml != null){
            theUI.ecs100Canvas.removeMouseListener(theUI.ml);
            theUI.ecs100Canvas.removeMouseMotionListener(theUI.ml);
        }
        //mouseevents    added 01/2014
        if (mouseEventQueue==null){
        ...
        if (obj != null) {
            ...
            theUI.ecs100Canvas.addMouseListener(theUI.ml);
        }
    }
    ...
    public static void setMouseMotionListener(UIMouseListener obj) {
        ...
        theUI.ml = new Ecs100MouseListener(obj);
        theUI.ecs100Canvas.addMouseListener(theUI.ml);
        theUI.ecs100Canvas.addMouseMotionListener(theUI.ml);
    }
